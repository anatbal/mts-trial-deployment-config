locals {
  vnet_address_space               = var.is_failover_deployment ? "10.1.0.0/16" : "10.0.0.0/16"
  subnet_address_prefixes          = var.is_failover_deployment ? "10.1.1.0/24" : "10.0.1.0/24"
  endpoint_subnet_address_prefixes = var.is_failover_deployment ? "10.1.2.0/24" : "10.0.2.0/24"
}
